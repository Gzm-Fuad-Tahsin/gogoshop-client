...
export async function loader({ params }) {
    return await fetchJson(`${import.meta.env.VITE_SERVER_ADDRESS}/completedOrder/${params.orderId}`);
        ...
        <>
            ...
            <div className="w-full lg:w-[900px] mx-auto px-2 md:px-5 my-2">
                ...
                <div>
                    ...
                    <OrderInfo orderInfo={{ orderNo, orderDate, deliveryDate, paidThrough }}></OrderInfo>
                </div>
                ...
                <div className=" text-[#666666] font-medium text-base  md:text-base px-0 md:px-5">
                    ...
                    <div className='grid grid-cols-2'>
                        ...
                        <p className='mt-3 text-right'>{paidThrough}</p>
                    </div>
                </div>
...
export default PreviousOrderStatement;