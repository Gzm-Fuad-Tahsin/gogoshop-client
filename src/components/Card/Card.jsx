...
const Card = ({ product }) => {
  ...
  return (
    <>
      ...
      <div className="card border-2 w-[140px] h-[180px] md:w-[190px] md:h-[300px] lg:w-[220px]  hover:shadow-lg m-2">
        <Link to={`/subcategory/${u_name}`}>
          <figure>
        ...
        <button onClick={() => handleCart(u_name)} className="btn btn-sm btn-circle bg-root-100 hover:bg-root-200 md:w-[180px] md:h-[46px] lg:w-[208px] lg:h-[38px] border-0 rounded-xl md:font-medium md:text-[20px] normal-case absolute bottom-1 right-1 md:bottom-1 md:left-1 md:gap-2">
