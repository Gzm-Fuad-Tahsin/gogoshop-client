  ...
  return (
    <>
      <div className="card border-2 w-[140px] h-[180px] md:w-[200px] md:h-[320px] lg:w-[230px] lg:h-[340px] 2xl:w-[230px] 2xl:h-[340px]">
        ...
        <button className="btn btn-sm btn-circle bg-root-100 hover:bg-root-200 md:w-[190px] md:h-[46px]  lg:w-[220px] lg:h-[46px] 2xl:w-[220px] 2xl:h-[46px] border-0 rounded-[20px] md:font-medium md:text-[20px] lg:font-medium lg:text-[20px] 2xl:font-medium 2xl:text-[20px] normal-case absolute bottom-1 right-1 md:bottom-1 md:left-1 md:gap-2 lg:bottom-1 lg:left-1 lg:gap-2 2xl:bottom-1 2xl:left-1 2xl:gap-2">
