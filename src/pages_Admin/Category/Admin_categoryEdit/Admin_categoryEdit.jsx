...
const Admin_categoryEdit = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            axios.get(`${import.meta.env.VITE_SERVER_ADDRESS}/admin/category-list/${category_slug}/edit`)
                .then(data => {
                    if (data.status === 200) {
                        setCategroy(data.data);
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='max-w-5xl pt-8 lg:pt-10 px-4 lg:px-10 '>
                            ...
                            <div className='pt-8  grid grid-cols-1 md:grid-cols-2'>
                                ...
                                <div className="col flex flex-col items-center md:items-start mb-7">
                                    <h2 className='text-xl md:text-2xl text-[#292D32] mb-7'>Edit Category</h2>
                                    <div
                                        ...
                                        <div className='grid grid-cols-1 justify-center gap-6 mb-6 '>
                                            <div className=''>
                                                <div className='flex items-center'>
                                                    <label htmlFor="first_name" className="block my-1 pl-2 text-md font-medium">Name</label>
                                                </div>
                                                <div>
                                                    <input
                                                        autoComplete='off'
                                                    ...
                                                    {errors.categoryname && <p className='p-1 text-xs text-red-600'>{errors.categoryname.message}</p>}
                                                </div>
...
export default Admin_categoryEdit;