...
export default function Admin_subcategoryItem_action({subcategory_slug,handleSubcategoryDelete}) {
    ...
    return (
        <>
            ...
            >
                <MenuItem  onClick={() => naviagteTo(`/admin/subcategory-list/${subcategory_slug}/edit`)} disableRipple p={0} className=''>
                ...
                <MenuItem onClick={()=>handleSubcategoryDelete(subcategory_slug)} sx={{color:'#FF754C'}} disableRipple m={0}>
