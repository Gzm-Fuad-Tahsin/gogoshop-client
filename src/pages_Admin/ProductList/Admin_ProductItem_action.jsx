...
export default function Admin_ProductItem_action({product_slug,handleProductDelete}) {
    ...
    return (
        <>
            ...
            >
                <MenuItem  onClick={() => naviagteTo(`/admin/products-list/${product_slug}/edit`)} disableRipple p={0} className=''>
                ...
                <MenuItem onClick={()=>handleProductDelete(product_slug)} sx={{color:'#FF754C'}} disableRipple m={0}>
