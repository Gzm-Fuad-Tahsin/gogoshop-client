...
import Upload_TopbannerItem from './Upload_TopbannerItem';


const Upload_Topbanner = () => {
                ...
                banners ?
                    <>
                        <div className='max-w-5xl mx-auto pt-8 lg:pt-10 px-4 lg:px-10 '>
                            ...
                            <h2 className='text-xl md:text-2xl text-[#292D32]'>Upload Top Banner</h2>
                            ...
                            {/* table of previous uploaded Image  */}
                            <div className='mt-5 md:mt-9 mx-auto  overflow-x-scroll '>
                                ...
                                {
                                    banners && banners.map((banner, _idx) => <Upload_TopbannerItem key={_idx} count={_idx + 1} banner={banner} handleStatusChange={handleStatusChange} handleBannerDelete={handleBannerDelete}/>)
...
export default Upload_Topbanner;