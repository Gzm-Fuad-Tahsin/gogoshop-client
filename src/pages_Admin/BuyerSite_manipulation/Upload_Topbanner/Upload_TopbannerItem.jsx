...
const Upload_TopbannerItem = ({ banner, count, handleStatusChange, handleBannerDelete }) => {
    ...
    return (
        <div className="w-full mx-auto py-2 grid grid-cols-5 text-[#A3A3A3] text-lg hover:bg-slate-100 border-b">
...
export default Upload_TopbannerItem;